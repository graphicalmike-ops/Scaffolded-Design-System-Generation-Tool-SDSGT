...
| Contract                                                          | Status                                                                    |
| ----------------------------------------------------------------- | ------------------------------------------------------------------------- |
| Token spec (DTCG JSON shape)                                      | Decided (not yet built) — see "Token spec — file layout" below. |
| Naming & structure conventions                                    | Decided (not yet built) — see "Naming & structure conventions" below. |
| Preset library (actual token files behind the preset menus above) | Values decided (not yet written as real files) — see the per-group sections below (Color primitives through Fixed defaults). |
| Fixed defaults (breakpoints, grid)                                | Decided (not yet built) — see "Fixed defaults" below. |
